...
# sys.path.append("/home/niu/Python/Seg3D/architectures/UXNet3D")
from architectures.utils.uxnet_util import uxnet_conv
...
def build_uxnet_model(config=None):
    model = UXNET(
        in_chans=config["model_parameters"]["in_channels"],
        feat_size=config["model_parameters"]["embed_dims"],
        ...
        hidden_size=config["model_parameters"]["decoder_head_embedding_dim"],
        depths=config["model_parameters"]["depths"],
        layer_scale_init_value=config["model_parameters"]["layer_scale_init_value"],
        out_chans=config["model_parameters"]["num_classes"],
        drop_path_rate=config["model_parameters"]["decoder_dropout"],
